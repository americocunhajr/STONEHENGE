...
% -----------------------------------------------------------------
function plot_piezomagbeam_animation_mobile_gif(series,f,Omega,...
                                                dim,beta,IC)
    warning('off')
    ...
    v_name = ['f' , num2str(f*1e3),'_O', num2str(Omega*1e1),'_ic', ...
              num2str(IC(1)),num2str(IC(2)),num2str(IC(3))       , ...
              '_beta' , num2str(beta*10) , '_mobile.gif'];
...
% 	[imind,cm] = rgb2ind(im,256); 
    ...
    for n=1:Njump:Ndt     
      ...
      if n == 1 
          imwrite(imind,cm,v_name,'gif', 'Loopcount',inf); 
      else 
          imwrite(imind,cm,v_name,'gif','WriteMode','append'); 
      end 
    end 
    %myVideo.close()
end
