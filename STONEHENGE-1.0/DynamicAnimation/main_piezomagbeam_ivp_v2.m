...
%
%    d2x/dt2 + 2*ksi*dx/dt - 0.5*x*(1-x^2) - (1+beta*|x|)*chi*v = f*cos(Omega*t)
%
...
%
%  A. Triplett and D.D. Quinn
%  The Effect of Non-linear Piezoelectric Coupling on Vibration-based 
%  Journal of Intelligent Material Systems and Structures
%  vol. 20 pp. 1959-1967, 2009
%
% ----------------------------------------------------------------- 
%  programmers: 
...
disp(' ');
% -----------------------------------------------------------
%% Plot: non-inertial frame of reference (GIF)
% -----------------------------------------------------------
...
plot_piezomagbeam_animation_mobile_gif(series,  Xpar.f  , Xpar.Omega,...
                                                  dim , Xpar.beta, IC);
