...
for n=1:N_cycles
    ...
    if n > 1 && orbit_flag == 0
        % distance between two points in the Poincar� map
...
%saveas(gcf,'../../../results/voltage_OGY.png')
...
%saveas(gcf,'../../../results/Poincare_OGY.png')
...
xlim([0 time(end)]);
%saveas(gcf,'../../../results/force_OGY.png')
