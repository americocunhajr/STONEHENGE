% -----------------------------------------------------------------
%  plot_piezomagbeam_animation_inertial.m
%
%  This functions plots an animation for the nonlinear dynamics
%  of an piezo-magneto-elastic beam in inertial frame of
%  reference.
%
%  input:
...
% -----------------------------------------------------------------
function plot_piezomagbeam_animation_inertial(series, f  ,Omega,...
                                                 dim,beta,  IC)
warning('off')
    ...
    for n=1:Njump:Ndt 
        ...
        fh03 = rectangle('Position' ,[xm1,ym1,0.10*rb_length,0.10*rb_length], ...
                         ...
                         'FaceColor',  [0.9100 0.4100 0.1700] , 'Curvature',0.2);
        ...
        % draw beam
        fh07 = plot(xvline1+phi1*Qdisp(n),yvline1 - zmesh , ...
        ...
        if beta ~= 0
            ...
            fh11 = annotation('arrow',[0.52-cos_Omega_t*0.17 0.61-cos_Omega_t*0.17], ...
                              [0.81 0.835] , 'color' , [1,0,0], 'HeadLength' , 5   , ...
        ...
        text(-0.6*xmin,0.4*ymin,['inertial frame', newline, ...
                                 'of reference']);
        ...
        text(-0.2,-0.7,'Global sensitivity analysis on bistable energy harvester (2020)', ...
