...
% -----------------------------------------------------------------
function [fig,F] = plot_piezomagbeam_animation_inertial(time,Qdisp,Qvolt,f,Omega,...
...
warning('off')
    ...
    % file save name
    v_name = ['f',num2str(f*1e3),'_O',num2str(Omega*1e1),'_ic',num2str(IC(1)),num2str(IC(2)),num2str(IC(3)),'_beta',num2str(beta*10),'_inertial'];
    ...
    for n=1:Njump:Ndt 
        ...
        if beta ~= 0
            ...
            fh11 = annotation('arrow',[0.52-cos_Omega_t*0.17 0.61-cos_Omega_t*0.17],[0.81 0.835],...
